...
func (r *TodoListPostgres) Create(userId int, list restwebprj.TodoList) (int, error) {
	tx, err := r.db.Begin()
...
func (r *TodoListPostgres) GetAll(userId int) ([]restwebprj.TodoList, error) {
	var lists []restwebprj.TodoList
...
func (r *TodoListPostgres) GetById(userId, listId int) (restwebprj.TodoList, error) {
	var list restwebprj.TodoList
